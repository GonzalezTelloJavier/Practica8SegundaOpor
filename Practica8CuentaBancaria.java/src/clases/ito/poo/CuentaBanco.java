...
public class CuentaBanco implements Arreglo<CuentaBancaria> {
	...
	public void BorrarCuenta(CuentaBancaria item) throws EliminarCuenta{
		if(item.getSaldo()==0) {
			throw new EliminarCuenta("Una cuenta que tenga deudas o dinero en su cuenta no puede ser eliminada");
		}
	}
