...
public class CuentaBancaria implements Comparable<CuentaBancaria> {
	...
	private void NumeDeCuenta(long numCuenta) throws NumCuenta{
		if (9999>=numCuenta)
			throw new NumCuenta("No se puede crear una cuenta menor a 9999");
	}
	...
	public void setNumeCuenta(long newNumCuenta)throws NumCuenta {
