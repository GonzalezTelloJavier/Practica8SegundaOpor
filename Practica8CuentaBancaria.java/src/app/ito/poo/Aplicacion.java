...
import clases.ito.poo.CuentaBanco;
...
public class Aplicacion {
	...
	static CuentaBanco c;
	static CuentaBanco e;
	
	
	static void menu() throws NumCuenta, Saldo, Retiro, Deposito, HeadlessException, CuentaExistente, EliminarCuenta {
		inicializa();
		...
		default:JOptionPane.showMessageDialog(null,"Ingrese aquí la opción deseada");
			...
			JOptionPane.showMessageDialog(panel,e.getMessage(),"ERROR", JOptionPane.ERROR_MESSAGE);
		}catch(EliminarCuenta e) {
			JOptionPane.showMessageDialog(panel,e.getMessage(),"ERROR", JOptionPane.ERROR_MESSAGE);
		}
		}
	}
	
	static clases.ito.poo.CuentaBancaria capturarCuenta() throws NumCuenta,Saldo {
		clases.ito.poo.CuentaBancaria n=new clases.ito.poo.CuentaBancaria();
	...
	static void agregarCuenta() throws NumCuenta, Saldo, HeadlessException, CuentaExistente {
		clases.ito.poo.CuentaBancaria nueva;
		nueva=capturarCuenta();
		if(c.addItem(nueva)) {
			JOptionPane.showMessageDialog(null,"Se agregó la cuenta con exito");
			if(c.isFull())
				c.crecerArreglo();
		}
		else
	...
	static void borrarCuenta() throws EliminarCuenta {
		int pos=0;
		if(c.isFree())
	...
	static void mayor10mil() {
		if(c.isFree())
			...
			int vacio=0;
			clases.ito.poo.CuentaBancaria copia[]=new clases.ito.poo.CuentaBancaria[c.getSize()];
			for(int i=0;i<c.getSize();i++)
